...
char* disassemble_word(uint16_t word) {
    ...
    if (opcode >= 0b11000 && opcode <= 0b11111) {
        ...
        case 0b11100: sprintf(result, "PUSH r%d\n", rd); return result;
        case 0b11101: sprintf(result, "POP  r%d\n", rd); return result;
        case 0b11110: sprintf(result, "LDB  r%d, [r%d+%d]\n", rd, rs1, imm); return result;
        case 0b11111: sprintf(result, "STB  r%d, [r%d+%d]\n", rd, rs1, imm); return result;
        }
    }
